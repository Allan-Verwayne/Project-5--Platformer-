...
unsigned int LEVELB_DATA[] =
{
    ...
    24, 0, 0, 0, 0, 1, 0, 0,26,31,26,29,26,27,29,32,33,31,
    24, 0, 0, 1, 0, 0, 0, 0,27, 3, 2, 7, 2, 2, 2, 2, 2, 2,
    24, 0, 0, 0, 0, 1, 0, 0,27, 2, 3, 2, 2, 3, 2, 2, 3, 2,
    24, 0, 0, 1, 0, 0, 0, 0,26, 2, 2, 2, 2, 2, 2, 7, 3, 2,
    24,26,27,28,29,26,29,27,2, 3, 2, 7, 3, 2, 3, 2, 7, 2,
...
{
    GLuint map_texture_id = Utility::load_texture("assets/world/Overworld Tiles Pack/Tileset_12.png");
...
void LevelB::update(float delta_time)
{
    ...
    if (m_state.player->get_position().x > 15.0f) m_state.next_scene_id = 2;
}
